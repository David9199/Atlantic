        ...
        <nav className="bg-blue-500 p-4" style={{ backgroundColor: '#1E3A8A' }}>
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="space-x-4">
                    ...
                    <Link className="text-white px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700" href="/create">
                        Create
                    </Link>
                    <Link className="text-white px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700" href="/services">
                        Services
                    </Link>
